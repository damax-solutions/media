...
class UploadServiceTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->service = new UploadService($this->mediaRepository, $this->storage, $this->assembler);
    }

    /**
     * @test
     */
    public function it_throws_exception_on_missing_media()
    {
     ...
     * @test
     */
    public function it_throws_exception_on_invalid_media_input()
    {
        $command = new UploadMedia();
        $command->mediaId = '183702c5-30de-11e8-97f3-005056806fb2';
